CLASS lsc_zbp_i_online_shop_mic DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
    METHODS save_modified REDEFINITION.
ENDCLASS.

CLASS lsc_zbp_i_online_shop_mic IMPLEMENTATION.

  METHOD save_modified.
    DATA : lt_online_shop_as TYPE STANDARD TABLE OF zshop_as_mic,
           ls_online_shop_as TYPE                   zshop_as_mic.
...
CLASS lhc_zbp_i_online_shop_mic  DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
...
CLASS lhc_zbp_i_online_shop_mic  IMPLEMENTATION.
...
DATA:
      online_shops TYPE TABLE FOR UPDATE zi_online_shop_mic,
      online_shop  TYPE STRUCTURE FOR UPDATE zi_online_shop_mic.

    READ ENTITIES OF zi_online_shop_mic IN LOCAL MODE
       ENTITY Online_Shop
        ALL FIELDS
    ...
    LOOP AT lt_online_shop_result INTO DATA(online_shop_read).
      ...
      ENDIF.
    ENDLOOP.
    MODIFY ENTITIES OF zi_online_shop_mic IN LOCAL MODE
    ENTITY zi_online_shop_mic UPDATE SET FIELDS WITH online_shops
